...
setup(
  ...
  download_url = 'https://github.com/RossJamesUrquhart/HPC_submission_tools/archive/refs/tags/v0.2.2-alpha.tar.gz',    # I explain this later on
  ...
  classifiers=[
    ...
    'Programming Language :: Python :: 3.9.7',      #Specify which pyhton versions that you want to support
  ],
)